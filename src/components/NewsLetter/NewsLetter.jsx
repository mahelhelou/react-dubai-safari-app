		...
		<div className='news-letter'>
			<div className='news-letter-container'>
				...
				<div className='news-letter-content'>
					<h2 className='news-letter-content-title'>Your Dubai itinerary is waiting.</h2>
					<p className='news-letter-content-desc'>Recieve a curated 48-hour itinerary featuring the most iconic experience in Dubai, straight to your inbox.</p>
