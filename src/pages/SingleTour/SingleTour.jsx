...
const SingleTour = () => {
	...
	return (
		<section className='tour'>
			...
			<p className='tour-description'>Discover a different side of Dubai an a fun-filled safari across the desert. Try sandboarding, dune bashing and a camel ride, with the option to add an electifying quad bike ride or immersive Al Khayma Camp dinner experience to your adventure.</p>
			<div className='tour-more-information'>
				...
				<div className='tour-info-item'>
					...
					<p className='tour-info-item-desc'>Cancel up to 24 hours in advance to recieve a full refund</p>
				</div>
				<div className='tour-info-item'>
					<div className='tour-info-item-title'>
					...
					<p className='tour-info-item-desc'>Keep your travel plan flexible -- book your spot and pay nothing today.</p>
				</div>
				<div className='tour-info-item'>
					<div className='tour-info-item-title'>
					...
					<p className='tour-info-item-desc'>Special health and safety measures are in place. Check your activity voucher once you book for full details.</p>
				</div>
				<div className='tour-info-item'>
					<div className='tour-info-item-title'>
